...
function CreateCabinForm({ onCloseModal, cabinToEdit = {} }) {
  // Destructuring these values from the cabinToEdit object
  ...
  // Getting the create function from the useCreateCabin custom hook
  const { isCreating, createCabin } = useCreateCabin();

  // Getting the update function from the useUpdateCabin custom hook
  ...
  function onSubmit(data) {
    ...
    // if it is edditing run the following function
    if (isEditSession)
      updateCabin(
    ...
    // Else if it is not edditing "Creating" create a new cabin
    else
      createCabin(

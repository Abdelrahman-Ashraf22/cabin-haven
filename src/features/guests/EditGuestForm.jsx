...
function EditGuestForm({ onCloseModal, guestToEdit = {} }) {
  ...
  // Destructuring the fullName from the previous values
  ...
  // Getting these functions from the useUpdateGuest custom hook
  const { updateGuest, isUpdating } = useUpdateGuest();

  // Getting these functions from the useCountries custom hook
